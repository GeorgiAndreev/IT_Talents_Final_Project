...
border: solid;
	...
	action: "/NewssiteProject/jsp2/news-green.jsp";
	color: #ffff00;
	height: 262px;
	width: 2120px;
	background-image:
...
<form action="http://localhost:8080/ServiceDemo/news-short.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/en1.png" alt="Submit" width="400" height="150"></form>
<form action="http://localhost:8080/ServiceDemo/news-short.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/pol1.png" alt="Submit" width="150" height="150"></form>
<form action="http://localhost:8080/ServiceDemo/news-short2.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/ball1.jpg" alt="Submit" width="150" height="150"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/tror1.png" alt="Submit" width="150" height="150"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/tech1.png" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/he1.png" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/culture1.png" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/smile0.jpg" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp2/news-space7.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/home0.jpg" alt="Submit" width="150" height="150"></form>
			</section>
...
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/pol1.png" alt="Submit" width="150" height="150"></form>
		<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/ball1.jpg" alt="Submit" width="150" height="150"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/tror1.png" alt="Submit" width="150" height="150"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/tech1.png" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/he1.png" alt="Submit" width="150" height="150"></form>		
<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/culture1.png" alt="Submit" width="150" height="150"></form>		
			<form action="/NewssiteProject/jsp/login.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/smile0.jpg" alt="Submit" width="150" height="150"></form>		
						<form action="/NewssiteProject/jsp2/news-space6.jsp"><input class="m" type="image" src="/NewssiteProject/imgs/home0.jpg" alt="Submit" width="150" height="150"></form>		
...
<form style="cursor: url('/NewssiteProject/imgs/up-arrow.png'), pointer, default" action="/NewssiteProject/jsp/login.jsp"><input title="ВЛЕЗ В ПРОФИЛА СИ" id="login" class="log" type="image" src="/NewssiteProject/imgs/login2.png" alt="Submit" width="160" height="160"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input title="РЕГИСТРИРАЙ СЕ" id="reg" class="reg" type="image" src="/NewssiteProject/imgs/reg1.png" alt="Submit" width="160" height="160"></form>
...
<form action="/NewssiteProject/jsp/login.jsp"><input title="ЗАПИШИ СЕ ЗА БЮЛЕТИН" id="login" class="log" type="image" src="/NewssiteProject/imgs/mail1.png" alt="Submit" width="260" height="160"></form>
<form action="/NewssiteProject/jsp/login.jsp"><input title="СВЪРЖИ СЕ С НАС" id="home" class="home" type="image" src="/NewssiteProject/imgs/contact1.jpg" alt="Submit" width="240" height="160"></form>
...
<!--  https://www.timeanddate.com/clocks/free.html-->
			...
			<section class="draw-quotes">
				...
				<form>
					...
					<br> <input class="draw-quotes" type="submit"
						value="Изтегли новина!">
				</form>
		...
		<section class="about-the-center">
			...
			<article>
				...
				<p>
					...
					<br> Страната ни е вече в сигурни ръце, най-накрая човек, който не лъже и не отлага ще я оглави
				</p>
			</article>
