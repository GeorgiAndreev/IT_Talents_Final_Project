...
border: solid;
	...
	height: 262px;
	width: 2120px;
	/*)background-image: url(/NewssiteProject/imgs/);*/
    border-radius: 25px;
}
...
<body>
	...
	<div class="wrapper">
		...
		<h2>
					<font size="100">EverydayNews.com</font>
		</h2>
		...
		<aside class="left">
			...
			<section class="search-for-events">
				...
				<form class="inquiry">
					<font size="20">Какво мислите за програмистите?</font><br>
					<br> <input type="radio" name="gender" value="male" checked><font
						size="20">Готини са. </font><br>
					<br>
					<br> <input type="radio" name="gender" value="female"><font
						size="20">Много са готини.</font><br>
					<br>
					<br> <input type="radio" name="gender" value="other"><font
						size="20">Турбо мега готини са.</font> <input class="select-theme"
						type="submit" value="ГЛАСУВАЙ!">
				</form>
			</section>
		</aside>
