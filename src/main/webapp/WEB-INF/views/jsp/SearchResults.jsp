...
<%!public String textZaModala="Teeeeeekst na novina."; %>
		...
		<%String searhWord = request.getAttribute("searchWord").toString();
		...
		%>
		<div
			style="display: inline-block; zoom: 220%;border: solid;border-color: gray;background-color: #FFF68F; width: 700px; margin: 10px; 10 px; 10 px; 10 px; float: center;">
		...
		<!--  <table>
			...
			<form action='/NewssiteProject/single-new-web' method='get'>
				<input type="hidden" name="whichNewToShow" value="<%=allNews.get(index).getId()%>" />
