		...
		<div id="content1"
			...
			<%
				...
				if (request.getAttribute("newIdToShow") != null) {
					...
					ArrayList<Article> allNews = context.getBean(NewArticleDAO.class).allSportNews;
					context.close();
			...
			<div id="content" class="test"
				...
				<img
					...
					<%String image = "/NewssiteProject/article-imgs/"+ singleNew.getArticlePic();%>
					src='<%=image%>'>
			</div>
