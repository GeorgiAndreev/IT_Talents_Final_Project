...
<canvas id="canvas"></canvas>
	...
	<div class="register" style="zoom:150%; margin-left:520px; float:left;">
         <form class="form-signin" action="Register" method="POST" enctype="multipart/form-data">       
	       <h2 style="background-color:white; color:blue; border-color:white; border-radius:0px;" >REGISTER FAILED</h2><br>
	      <input id="username" type="text" 		class="form-control" style="border:1px solid #ff0000" name="username" 	placeholder="Username" 	required="" autofocus="" /> </br>
	      <input type="text" 		class="form-control"  style="border:1px solid #ff0000" name="first_name" 		placeholder="First Name" 		required=""/>  </br>  
	      <input type="text" 		class="form-control" style="border:1px solid #ff0000" name="last_name" 		placeholder="Last Name" 		required=""/>  </br>  
	      <input type="password" 	class="form-control" style="border:1px solid #ff0000" name="password" 	placeholder="Password" 	required=""/>  
	      <input type="password" 	class="form-control" style="border:1px solid #ff0000" name="password2" 	placeholder="Password again" required=""/>   
	      <input type="text" 		class="form-control" style="border:1px solid #ff0000" name="email" 		placeholder="Email" 	required=""/>   </br> 
	      <input type="text" 		class="form-control" style="border:1px solid #ff0000" name="address" 	placeholder="Address" 	required=""/>   </br>  
